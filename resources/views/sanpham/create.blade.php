...
@endif
<a href="{{route('danhsachsanpham.index') }}"> <button type="button" class="btn btn-default"><img src="{{asset('theme/AdminLTE/img/left-arrow.png')}}" /></button></a>
<h2><span style="color:#f94141"><b>THÊM SẢN PHẨM</b></span></h2>
<form method="post" action="{{ route('danhsachsanpham.store') }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select name="nsx_ma" class="form-control">
            @foreach($danhsachnhasanxuat as $nsx)
